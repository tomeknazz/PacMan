...
public:
	punkt(const float x, const float y, const float radius = 10.f) {
		...
		shape.setFillColor(Color::White); // Mozesz ustawiÊ dowolny kolor
	}
...
//
//				// Sprawdü, czy punkt nie koliduje ze scianami
...
//				}
//
//				// Sprawdü, czy punkt nie jest w strefie startowej duszkow
//			
//
//				if (!collidesWithWall) {
//					CircleShape point(10); // PromieÒ 10 = srednica 20
...
//			cerr << "Nie mozna zaladowaÊ czcionki!\n";
//			return;
//		}
//
//		Text scoreText;
...
//	}
//
//	// Funkcja sprawdzajaca, czy duszek ma zblizyÊ sie do PacMana
...
//		float distance = sqrt(dx * dx + dy * dy); // OdleglosÊ do PacMana
//		dx /= distance;
//		dy /= distance;
//
